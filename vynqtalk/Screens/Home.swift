        ...
        HStack {
            ...
            Button(action: {}) {
                Circle()
                    ...
                    .frame(
                        width: AppTheme.Layout.iconButton,
                        height: AppTheme.Layout.iconButton
                    )
                    .overlay(
        ...
        .background(
            RoundedRectangle(cornerRadius: AppTheme.Layout.cornerRadiusMedium)
                ...
                .overlay(
                    ...
                    .stroke(
                        isFocused
                            ? AppTheme.AccentColors.primary.opacity(0.5)
                            : Color.clear,
                        lineWidth: 1.5
                    )
                )
        ...
        Button(action: action) {
            HStack(spacing: 14) {
                ...
                ZStack(alignment: .bottomTrailing) {
                    avatar
                        .frame(
                            width: AppTheme.Layout.avatarMedium,
                            height: AppTheme.Layout.avatarMedium
                        )
                ...
                VStack(alignment: .leading, spacing: 5) {
                    ...
                    HStack(spacing: 6) {
                        if isTyping {
                            ...
                            Text(
                                user.bio ?? user.email ?? "Start a conversation"
                            )
                            .font(
                                .system(
                                    size: 14,
                        ...
                        if let unreadCount = user.unreadMessages?.count,
                            unreadCount > 0
                        {
                            Circle()
